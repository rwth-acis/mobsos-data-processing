...
public class DatabaseInsertStatement {
	...
	public static String returnInsertStatement(MonitoringMessage monitoringMessage, SQLDatabaseType databaseType, String DB2Schema, String table) throws Exception{		
		...
		if(databaseType == SQLDatabaseType.MySQL){
			...
			if(table.equals("MESSAGE")){
				return returnDB2MessageStatement(monitoringMessage, DB2Schema);
			}
			
			else if(table.equals("AGENT")){
				return returnDB2AgentStatement(monitoringMessage, DB2Schema);
			}
			
			else if(table.equals("SERVICE")){
				return returnDB2ServiceStatement(monitoringMessage, DB2Schema);
			}
			
			else if(table.equals("NODE")){
				return returnDB2NodeStatement(monitoringMessage, DB2Schema);
			}
			
			else if(table.equals("REGISTERED_AT")){
				return returnDB2RegisteredAtStatement(monitoringMessage, DB2Schema);				
			}
	 ...
	 * 
	 */
	private static String returnDB2MessageStatement(MonitoringMessage monitoringMessage, String DB2Schema){
		String returnStatement;
	 ...
	 * 
	 */
	private static String returnDB2AgentStatement(MonitoringMessage monitoringMessage, String DB2Schema) throws Exception{
		String returnStatement;
	 ...
	 * 
	 */
	private static String returnDB2ServiceStatement(MonitoringMessage monitoringMessage, String DB2Schema) throws Exception {
		String returnStatement;
	 ...
	 * 
	 */
	private static String returnDB2RegisteredAtStatement(MonitoringMessage monitoringMessage, String DB2Schema) throws Exception {
		String returnStatement;
		if(monitoringMessage.getTimestamp() == null || monitoringMessage.getSourceNode() == null)
			throw new Exception("Missing information for 'registered at' entity!");
	 ...
	 * 
	 */
	private static String returnDB2NodeStatement(MonitoringMessage monitoringMessage, String DB2Schema) throws Exception {
		String returnStatement;
		if(monitoringMessage.getEvent() == Event.NODE_STATUS_CHANGE){
			if(monitoringMessage.getSourceNode() == null)
				throw new Exception("Missing information for persisting node entity!");
