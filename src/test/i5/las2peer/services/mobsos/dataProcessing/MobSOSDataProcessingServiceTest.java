...
public class MobSOSDataProcessingServiceTest {
  ...
  private static final ServiceNameVersion testServiceClass = new ServiceNameVersion(
      MobSOSDataProcessingService.class.getCanonicalName(), "0.1");
  ...
  public void testDefaultStartup() {
    try {
      ...
      MonitoringMessage ccm = new MonitoringMessage((long) 1376750476, MonitoringEvent.SERVICE_CUSTOM_MESSAGE_1, sNode,
          null, dNode, null, "1337");
      // TODO
      ...
      // Monitoring messages
      MonitoringMessage m1 = new MonitoringMessage((long) 1376750476, MonitoringEvent.NODE_STATUS_CHANGE, sNode, "1",
          dNode, "2", "{}");
      MonitoringMessage m2 = new MonitoringMessage((long) 1376750476, MonitoringEvent.NODE_STATUS_CHANGE, sNode, "1",
          dNode, "2", "{\"msg\": \"RUNNING\"}");
      MonitoringMessage m3 = new MonitoringMessage((long) 1376750476, MonitoringEvent.NODE_STATUS_CHANGE, sNode, "1",
          dNode, "2", "{\"msg\": \"CLOSING\"}");
      MonitoringMessage m4 = new MonitoringMessage((long) 1376750476, MonitoringEvent.SERVICE_ADD_TO_MONITORING, sNode,
          "1", dNode, "2", "{}");
      MonitoringMessage m5 = new MonitoringMessage((long) 1376750476, MonitoringEvent.AGENT_REGISTERED, sNode, "1",
          dNode, "2", "{\"msg\": \"UserAgent\"}");
      MonitoringMessage m6 = new MonitoringMessage((long) 1376750476, MonitoringEvent.HTTP_CONNECTOR_REQUEST, sNode,
          "1", dNode, "2", "{}");
      MonitoringMessage m7 = new MonitoringMessage((long) 1376750476, MonitoringEvent.SERVICE_CUSTOM_MESSAGE_1, sNode,
          "1", dNode, "2", "{}");
      MonitoringMessage m8 = new MonitoringMessage((long) 1376750476, MonitoringEvent.SERVICE_SHUTDOWN, sNode, "1",
          dNode, "2", "{}");
      MonitoringMessage m9 = new MonitoringMessage((long) 1376750476, MonitoringEvent.AGENT_REMOVED, sNode, "1", dNode,
          "2", "{}");
      ...
      MonitoringMessage m10 = new MonitoringMessage((long) 1376750476, MonitoringEvent.SERVICE_CUSTOM_MESSAGE_2, sNode,
          "1", dNode, "2", "test");
      MonitoringMessage m11 = new MonitoringMessage((long) 1376750476, MonitoringEvent.SERVICE_CUSTOM_MESSAGE_2, sNode,
          "1", dNode, "2", null);
